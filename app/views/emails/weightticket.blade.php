                                            ...
                                            <td valign="top" class="bodyContent" mc:edit="body_content00">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 20px;">{{ $weightticket["created_at"] }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                            ...
                                            <td valign="top" class="bodyContent" mc:edit="body_content01">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_pickup"]["bales"] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">Gross:</td>
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_pickup"]["gross"] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">Tare:</td>
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_pickup"]["tare"] }}</td>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td valign="top" class="bodyContent" mc:edit="body_content03">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td class="label">Scale:</td>
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_dropoff"]["scaler_account"][0]["name"] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">Scale Name:</td>
                                                    ...
                                                    <tr>
                                                        <td class="label">Bales:</td>
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_dropoff"]["bales"] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">Gross:</td>
                                                        <td style="padding-left: 20px;">{{ $weightticket["weightticketscale_dropoff"]["gross"] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="label">Tare:</td>
