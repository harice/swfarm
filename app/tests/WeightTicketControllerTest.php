...
//    }
    ...
    public function testMailLoadingTicket()
    {
        WeightTicket::shouldReceive('mailLoadingTicket')->once()->andReturn('foo');
        $this->call('PUT', 'apiv1/weightticket/mailLoadingTicket/22');
        $this->assertRequestOk();
    }
