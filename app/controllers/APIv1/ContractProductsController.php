...
use ContractProductsRepositoryInterface;
use Input;

class ContractProductsController extends BaseController {

	public function __construct(ContractProductsRepositoryInterface $repo)
    {
        $this->repo = $repo;
    }
