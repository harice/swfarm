...
(function($) {
    ...
    function Plot(placeholder, data_, options_, plugins) {
	    ...
	    function drawSeriesNumbers(series){
	            ...
	            for(var i = 0; i < points.length; i += ps){
	                ...
	                if(series.stack != null){  
	                    ...
	                    if(series.bars.numbers.showDataValue) {    
							...
							if(series.stackpercent)                   
								var number = series.data[i/3][hs].toFixed(2);
							else
								var number = series.data[i/3][hs];

							text = addCommaToNumber(number);                              
						}
						else{
